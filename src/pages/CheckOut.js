...
const addresses =[
  {
    ...
    country: 'USA',
    phone: 956082566,
    email:"kjslkfjkaj@gmail.com"
  },
  {
    name: 'Nishan Maharjan',
    street: '2560 creek side',
    city: 'Sacramento',
    zip_code: 95608,
    State: 'California',
    country: 'USA',
...
function CheckOut() {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-9">
                ...
                <ul role="list" className="divide-y divide-gray-100">
                  ...
                  <li key={address.email} className="flex justify-between gap-x-6 py-5 ">
                    ...
                    <div className="hidden sm:flex sm:flex-col sm:items-end">
                        ...
                        <p className="text-sm leading-6 text-gray-500">{address.zip_code}</p>
                        <p className="text-sm leading-6 text-gray-500">{address.country}</p>
                       </div> 
                  </li>
                 ))}
                </ul>
  ...
  {/* ------------------------------------------------------------------------------------- */}
        <div className="lg:col-span-2">
          <div className="mx-auto bg-white max-w-7xl px-0 sm:px-0 lg:px-8">
            <div className="border-t border-gray-200 px-4 py-6 sm:px-3">
                  ...
                  <div className="mt-6 flex justify-center text-center text-sm text-gray-500">
                    <p>
                      ...
                      <Link to="/">
                        <button
                          type="button"
                          className="font-medium text-indigo-600 hover:text-indigo-500 ml-6px"
                        >
                          Continue Shopping
